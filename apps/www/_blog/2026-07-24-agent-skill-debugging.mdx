...
The skill is built from the same investigation approach Supabase's own engineers already use to debug production issues, adapted here for customer-safe use through the `get_logs` MCP tool.
