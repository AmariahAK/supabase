...
The Grafana Cloud integration is available in the Supabase Dashboard. [Add the integration](https://supabase.com/dashboard/project/_/integrations/grafana/overview) and select a project to get a fully-configured instance in one click: authentication, metric scraping, and a pre-built dashboard tracking 200+ metrics, set up automatically.
...
The [Grafana Cloud integration](https://supabase.com/dashboard/project/_/integrations/grafana/overview) available in the Supabase Dashboard is the recommended path. You can still configure and run the setup manually by following the steps below.
