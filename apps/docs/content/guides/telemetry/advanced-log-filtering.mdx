...
Querying your entire log history might seem appealing. For Enterprise customers with a large retention range, you run the risk of timeouts because of the additional time required to scan the larger dataset.
